...
ActiveRecord::Schema.define(version: 20150623032020) do
  ...
  create_table "laby_docs", force: :cascade do |t|
    t.integer  "unid",         limit: 4
    t.integer  "content_id",   limit: 4
    t.string   "state",        limit: 15
    t.datetime "created_at"
  ...
  create_table "newsletter_delivery_logs", force: :cascade do |t|
    t.integer  "unid",              limit: 4
    t.integer  "content_id",        limit: 4
    t.string   "state",             limit: 15
    t.datetime "created_at"
    ...
    t.integer  "delivered_count",   limit: 4
    t.integer  "deliverable_count", limit: 4
    t.integer  "last_member_id",    limit: 4
  end

  add_index "newsletter_delivery_logs", ["content_id", "doc_id", "letter_type"], name: "content_id", using: :btree
  ...
  create_table "newsletter_requests", force: :cascade do |t|
    ...
    t.string   "letter_type",       limit: 15
    t.text     "subscribe_email",   limit: 65535
    t.text     "unsubscribe_email", limit: 65535
    t.text     "token",             limit: 65535
  end

  add_index "newsletter_requests", ["content_id", "request_state", "request_type"], name: "content_id", using: :btree

  create_table "newsletter_tests", force: :cascade do |t|
    t.integer  "unid",        limit: 4
    t.integer  "content_id",  limit: 4
    t.string   "state",       limit: 15
    t.string   "agent_state", limit: 15
  ...
  create_table "portal_article_categories", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "parent_id",  limit: 4,     null: false
    t.integer  "concept_id", limit: 4
    t.integer  "content_id", limit: 4
  ...
  create_table "portal_article_docs", force: :cascade do |t|
    t.integer  "unid",                 limit: 4
    t.integer  "content_id",           limit: 4
    t.string   "state",                limit: 15
    t.string   "agent_state",          limit: 15
    ...
    t.integer  "portal_group_id",      limit: 4
    t.text     "portal_category_ids",  limit: 65535
    t.text     "portal_business_ids",  limit: 65535
    t.text     "portal_attribute_ids", limit: 65535
    t.text     "portal_area_ids",      limit: 65535
    t.string   "rel_doc_ids",          limit: 255
    t.text     "notice_state",         limit: 65535
    t.string   "name",                 limit: 255
    t.text     "title",                limit: 65535
  ...
  create_table "portal_article_tags", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "name",       limit: 255
  ...
  create_table "portal_calendar_events", force: :cascade do |t|
    t.integer  "unid",             limit: 4
    t.integer  "content_id",       limit: 4
    t.string   "state",            limit: 15
    t.date     "event_start_date"
    t.date     "event_end_date"
    t.string   "event_uri",        limit: 255,        default: ""
    t.string   "title",            limit: 255
    t.text     "body",             limit: 4294967295
    t.integer  "event_genre_id",   limit: 4,          default: 0
    t.integer  "event_status_id",  limit: 4,          default: 0
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "portal_calendar_events", ["content_id", "event_start_date"], name: "content_id", using: :btree

  create_table "portal_calendar_genres", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "content_id", limit: 4
  ...
  create_table "portal_calendar_statuses", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "content_id", limit: 4
    t.string   "state",      limit: 255, default: "public"
    t.string   "title",      limit: 255, default: ""
  ...
  create_table "portal_group_areas", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "parent_id",  limit: 4,     null: false
    t.integer  "content_id", limit: 4
    t.integer  "concept_id", limit: 4
  ...
  create_table "portal_group_attributes", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "content_id", limit: 4
    t.integer  "concept_id", limit: 4
    t.integer  "site_id",    limit: 4
  ...
  create_table "portal_group_businesses", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "parent_id",  limit: 4,     null: false
    t.integer  "content_id", limit: 4
    t.integer  "concept_id", limit: 4
  ...
  create_table "portal_group_categories", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "parent_id",  limit: 4,     null: false
    t.integer  "content_id", limit: 4
    t.integer  "concept_id", limit: 4
  ...
  create_table "public_bbs_categories", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.string   "state",      limit: 255
    t.integer  "concept_id", limit: 4
    t.integer  "content_id", limit: 4
  ...
  add_index "public_bbs_categories", ["content_id"], name: "index_public_bbs_categories_on_content_id", using: :btree

  create_table "public_bbs_responses", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.integer  "content_id", limit: 4
    t.string   "state",      limit: 255
    t.integer  "thread_id",  limit: 4
  ...
  add_index "public_bbs_responses", ["content_id"], name: "index_public_bbs_responses_on_content_id", using: :btree
  add_index "public_bbs_responses", ["thread_id"], name: "index_public_bbs_responses_on_thread_id", using: :btree
  add_index "public_bbs_responses", ["user_id"], name: "index_public_bbs_responses_on_user_id", using: :btree

  create_table "public_bbs_tags", force: :cascade do |t|
    t.integer  "unid",       limit: 4
    t.string   "name",       limit: 255
    t.text     "word",       limit: 65535
    t.datetime "created_at"
  ...
  create_table "public_bbs_threads", force: :cascade do |t|
    t.integer  "unid",                 limit: 4
    t.integer  "content_id",           limit: 4
    t.string   "state",                limit: 255
    t.integer  "user_id",              limit: 4
    ...
    t.text     "portal_attribute_ids", limit: 65535
    t.text     "portal_area_ids",      limit: 65535
    t.string   "res_creation",         limit: 255
  end

  add_index "public_bbs_threads", ["content_id"], name: "index_public_bbs_threads_on_content_id", using: :btree
  add_index "public_bbs_threads", ["user_id"], name: "index_public_bbs_threads_on_user_id", using: :btree
