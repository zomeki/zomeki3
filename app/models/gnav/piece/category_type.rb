class Gnav::Piece::CategoryType < Cms::Piece
  ...
  def public_categories
    unless category_type
      return category_types.inject([]) {|result, ct|
        ct = GpCategory::CategoryTypePreloader.new(ct).preload(:public_root_categories_and_public_descendants)
    ...
    if (category_id = setting_value(:category_id)).present?
      ...
      category_type = GpCategory::CategoryTypePreloader.new(category_type).preload(:public_root_categories_and_public_descendants)
