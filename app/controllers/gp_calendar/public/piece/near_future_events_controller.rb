...
class GpCalendar::Public::Piece::NearFutureEventsController < GpCalendar::Public::Piece::BaseController
  ...
  def index
    today = Date.today
    @todays_events = GpCalendar::Event.public_state.all_with_content_and_criteria(@piece.content, date: today)
    @tomorrows_events = GpCalendar::Event.public_state.all_with_content_and_criteria(@piece.content, date: today.tomorrow)
