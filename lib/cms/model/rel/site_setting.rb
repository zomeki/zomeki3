module Cms::Model::Rel::SiteSetting
  ...
  attr_accessor :in_setting_site_map_default_Coordinate
  ...
  def setting_site_map_default_Coordinate
    setting = Cms::SiteSetting.where(:site_id => id, :name => 'map_default_Coordinate').first
    setting ? setting.value : "34.074442,134.551131";
  end
  ...
  def load_site_settings
    ...
    @in_setting_site_map_default_Coordinate      = setting_site_map_default_Coordinate
  end
