module Cms::Controller::Layout
  ...
  def render_public_as_string(path, options = {})
    ...
    begin
      ...
      body = Sys::Lib::Controller.render(ctl, act, params: opt, agent_type: options[:agent_type], session: session)
  ...
  def render_public_layout
    ...
    Cms::Lib::Layout.find_design_pieces(body, concepts, params).each do |name, item|
      ...
      begin
        ...
        data = Sys::Lib::Controller.render("#{mnames[0]}/public/piece/#{mnames[1]}", 'index', params: params, session: session)
